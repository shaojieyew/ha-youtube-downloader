...
from .downloader import async_search_and_download
...
async def async_setup(hass: HomeAssistant, config: dict):
    ...
    async def handle_play_song(call: ServiceCall):
        ...
        # Assuming music_dir is mounted to HA's /media
        # The mp3_path is absolute on the host/container.
        # We need the relative path from music_dir.
